...
################################################################################
## Form generated from reading UI file 'XMLuvationRirSZU.ui'
##
...
"font: bold;")
        ...
        sizePolicy3.setHeightForWidth(self.list_widget_xpath_expressions.sizePolicy().hasHeightForWidth())
        self.list_widget_xpath_expressions.setSizePolicy(sizePolicy3)
...
"font: bold;")
        ...
        sizePolicy2.setHeightForWidth(self.line_edit_csv_headers_input.sizePolicy().hasHeightForWidth())
        self.line_edit_csv_headers_input.setSizePolicy(sizePolicy2)
        ...
        sizePolicy5.setHeightForWidth(self.checkbox_group_matches.sizePolicy().hasHeightForWidth())
        self.checkbox_group_matches.setSizePolicy(sizePolicy5)
        ...
        sizePolicy6.setHeightForWidth(self.group_box_xml_output.sizePolicy().hasHeightForWidth())
        self.group_box_xml_output.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.text_edit_xml_output.sizePolicy().hasHeightForWidth())
        self.text_edit_xml_output.setSizePolicy(sizePolicy7)
...
"font: bold;")
        ...
        sizePolicy5.setHeightForWidth(self.combobox_csv_conversion_output_type.sizePolicy().hasHeightForWidth())
        self.combobox_csv_conversion_output_type.setSizePolicy(sizePolicy5)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(QCoreApplication.translate("MainWindow", u"Option:", None))
#if QT_CONFIG(tooltip)
...
#if QT_CONFIG(tooltip)
        self.checkbox_write_index_column.setToolTip(QCoreApplication.translate("MainWindow", u"ONLY FOR EXCEL: Write an index colum starting at 1.", None))
#endif // QT_CONFIG(tooltip)
