...
CURRENT_DIR = Path(__file__).parent # \XMLuvation\src
...
class MainWindow(QMainWindow):
    ...
    def __init__(self):
        ...
        from controllers.main_event_handler import UIEventHandler
    ...
    def initialize_attributes(self):
        ...
        from controllers.main_state_controller import ComboboxStateHandler
        from controllers.main_state_controller import SearchXMLOutputTextHandler
