...
class XPathValidator(QRunnable):
    ...
    def validate_xpath_expression(self):
        """Validate XPath expression and optionally test against an XML file.
...
class XPathBuilder(QObject):
    ...
    def _get_input_xpath(self) -> str:
        ...
        of the UI combo boxes and selected radio button, without emitting signals
...
def create_xpath_validator(xpath_expression: Optional[str] = None,
                           xml_file_path: Optional[str] = None) -> XPathValidator:
...
def create_xpath_validator(xpath_expression: Optional[str] = None,
    ...
    """Create a new XPathValidator worker."""
    return XPathValidator(xpath_expression, xml_file_path)
>>>>>>> fe48dc782e8990b856fd164ee4f7e98168c610e6
