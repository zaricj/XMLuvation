...
class Ui_PreBuiltXPathsManagerWidget(object):
    def setupUi(self, PreBuiltXPathsManagerWidget):
        ...
        PreBuiltXPathsManagerWidget.resize(737, 730)
    ...
    def retranslateUi(self, PreBuiltXPathsManagerWidget):
        ...
        self.button_create_save_config.setText(QCoreApplication.translate("PreBuiltXPathsManagerWidget", u"Save Autofill", None))
        ...
        self.button_pre_built_xpaths_load_config.setText(QCoreApplication.translate("PreBuiltXPathsManagerWidget", u"Load", None))
        self.button_pre_built_xpaths_delete_config.setText(QCoreApplication.translate("PreBuiltXPathsManagerWidget", u"Delete", None))
        ...
        self.button_pre_built_remove_selected.setText(QCoreApplication.translate("PreBuiltXPathsManagerWidget", u"Remove Selected", None))
        self.button_pre_built_remove_all.setText(QCoreApplication.translate("PreBuiltXPathsManagerWidget", u"Remove All", None))
    # retranslateUi
