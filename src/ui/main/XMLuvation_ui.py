...
"font: bold;")
        ...
        sizePolicy4.setHeightForWidth(self.label_options.sizePolicy().hasHeightForWidth())
        self.label_options.setSizePolicy(sizePolicy4)
...
"font: bold;")
        ...
        self.menu_bar.setGeometry(QRect(0, 0, 1275, 33))
